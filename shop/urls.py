...
urlpatterns = [
    ...
    path('products/<slug:slug>/add-to-cart/', views.AddToCartView.as_view(), name='add-to-cart'),
    ...
    path('search/products/', views.SearchProductView.as_view(), name='product-search'),
    path('orders/', views.OrderListView.as_view(), name='order-list'),
    path('orders/<int:pk>/', views.OrderDetailView.as_view(), name='order-detail'),
    path('post/review/<slug:slug>/', views.CreateReviewView.as_view(), name='post-review'),
    ...
    path('products/<slug:slug>/reviews/stats/', views.ProductReviewStatsView.as_view(), name='product-review-stats'),
