...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'category', 'type', 'initial_price', 'discounted_price', 'color_code', 'size', 'order_count', 'stripe_one_time_price_id', 'stripe_subscription_price_id', 'created_at')
